                        ...
                        <div class="form-group has-label">
                            ...
                            <div id="existing-container"
                                ...
                                <div class="position-relative m-1 existing-photo" data-id="{{ $foto->ID }}"
                                    ...
                                    <button type="button" class="btn-delete-existing" data-id="{{ $foto->ID }}"
...
window.KECURANGAN_EDIT_CONFIG = {
    ...
    initial: {
        salesId: "{{ $kecurangan->ID_SALES }}",
        assId: "{{ $kecurangan->ID_ASS }}",
        toko: "{{ $kecurangan->TOKO }}",
        jenisSanksi: "{{ $kecurangan->JENIS_SANKSI }}",
        deskripsiSanksi: "{{ $kecurangan->KETERANGAN_SANKSI }}"
    }
};
</script>
...
<script src="{{ asset('assets/js/edit-kecurangan.js') }}"></script>
@endpush